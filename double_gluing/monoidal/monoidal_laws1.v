...
Lemma double_glued_disp_leftunitor_law {E C : sym_mon_closed_cat} (pb : Pullbacks E)
  (L : sym_monoidal_functor C E) (K : functor C (E^opp)) (k : natural_contraction C E L K) :
  disp_leftunitor_law (disp_monoidal_leftunitor (double_glued_monoidal_data pb L K k))
    (disp_monoidal_leftunitorinv (double_glued_monoidal_data pb L K k)).
Proof.
  split.
  intros R1 R2 f12.
...
Lemma double_glued_disp_rightunitor_law {E C : sym_mon_closed_cat} (pb : Pullbacks E)
  (L : sym_monoidal_functor C E) (K : functor C (E^opp)) (k : natural_contraction C E L K) :
  disp_rightunitor_law (disp_monoidal_rightunitor (double_glued_monoidal_data pb L K k))
    (disp_monoidal_rightunitorinv (double_glued_monoidal_data pb L K k)).
Proof.
  split.
  intros R1 R2 f12.
  intros ((U1, l1), (X1, l1')).
...
Lemma double_glued_disp_associator_nat_leftwhisker {E C : sym_mon_closed_cat} (pb : Pullbacks E)
  (L : sym_monoidal_functor C E) (K : functor C (E^opp)) (k : natural_contraction C E L K) :
  disp_associator_nat_leftwhisker (disp_monoidal_associator (double_glued_monoidal_data pb L K k)).
Proof.
...
Lemma double_glued_disp_associator_nat_rightwhisker {E C : sym_mon_closed_cat} (pb : Pullbacks E)
    (L : sym_monoidal_functor C E) (K : functor C (E^opp)) (k : natural_contraction C E L K) :
  disp_associator_nat_rightwhisker (disp_monoidal_associator (double_glued_monoidal_data pb L K k)).
Proof.
...
Lemma double_glued_disp_associator_nat_leftrightwhisker {E C : sym_mon_closed_cat} (pb : Pullbacks E)
    (L : sym_monoidal_functor C E) (K : functor C (E^opp)) (k : natural_contraction C E L K) : 
...
Lemma double_glued_disp_associator_isolaw {E C : sym_mon_closed_cat} (pb : Pullbacks E)
    (L : sym_monoidal_functor C E) (K : functor C (E^opp)) (k : natural_contraction C E L K) :
  disp_associator_iso (disp_monoidal_associator (double_glued_monoidal_data pb L K k))
    (disp_monoidal_associatorinv (double_glued_monoidal_data pb L K k)).
Proof.
  intros R1 R2 R3.
...
Lemma double_glued_disp_associator_law {E C : sym_mon_closed_cat} (pb : Pullbacks E)
    (L : sym_monoidal_functor C E) (K : functor C (E^opp)) (k : natural_contraction C E L K) : 
disp_associator_law (disp_monoidal_associator (double_glued_monoidal_data pb L K k))
  (disp_monoidal_associatorinv (double_glued_monoidal_data pb L K k)).
Proof.
  split4.
  exact (double_glued_disp_associator_nat_leftwhisker pb L K k).
  exact (double_glued_disp_associator_nat_rightwhisker pb L K k).
  exact (double_glued_disp_associator_nat_leftrightwhisker pb L K k).
  exact (double_glued_disp_associator_isolaw pb L K k).
Qed.
